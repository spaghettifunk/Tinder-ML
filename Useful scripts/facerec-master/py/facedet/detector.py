...
if __name__ == "__main__":
	...
	detector = CascadedDetector(cascade_fn="haarcascade_frontalface_alt2.xml")
	eyesDetector = CascadedDetector(scaleFactor=1.1,minNeighbors=5, minSize=(20,20), cascade_fn="haarcascade_eye.xml")
	# detection
